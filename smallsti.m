...
%% Model plot
    plot ((0:intstart+intlength)/steps,pop(:,1:intstart+intlength+1)'),    holdnow=ishold(gcf);  hold on;plot((intstart:intstart+intlength)/steps,[popint(:,1:intlength+1)' popwith(:,1:intlength+1)'])
